...
<body>
	...
	<div class="qnw-wrap">
		...
		<div class="qnw-pnl">
			<form id="qnaWriteForm" action="${pageContext.request.contextPath}/qna/write.qfc" method="post">
				<div class="qnw-row">
					<label class="qnw-lbl" for="companyNumber">기업 선택</label>
					<select class="qnw-sel" name="companyNumber" id="companyNumber" required>
						<option value="">기업을 선택하세요</option>
						<c:forEach var="company" items="${companyList}">
				...
				<div class="qnw-row">
					<label class="qnw-lbl" for="postTitle">제목</label>
					<input class="qnw-inp" type="text" name="postTitle" id="postTitle" maxlength="100"
						placeholder="제목은 10자 이상 100자 이하로 입력해주세요" required>
				</div>

				<div class="qnw-row qnw-row-col">
					<label class="qnw-lbl" for="postContent">내용</label>
					<textarea class="qnw-ta" name="postContent" id="postContent" maxlength="1000"
